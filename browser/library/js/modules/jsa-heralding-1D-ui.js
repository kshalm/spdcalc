        ...
        var jsahomUI = SkeletonUI.subclass({
            ...
            initPlots : function(){
                ...
                self.elWaistSig.slider({
                    ...
                    change: function(){
                        ...
                        self.set( 'delT', (parseFloat(self.elWaistSig.slider( 'value' )) * waistConversion ));
                    },
                    slide: function(){
                ...
                self.on('change:delT', function( delT ){
                    ...
                    self.plot1DEff.setTitle("Time delay = " + delT/1e-15);
            ...
            refreshLine: function( delT ){
                ...
                line.attr('x', function(d) {
                        return self.plot1DEff.scales.x( d / waistConversion );
                    })
                    ;
            ...
            calc: function( props ){
                ...
                return when.all( promises ).then(function( values ){
                        ...
                        self.plot1DEff.setTitle("Hong-Ou-Mandel visibility = " + Math.round(1000*vis)/1000);//("Hong-Ou-Mandel Dip, Visbibility = ");
            ...
            set_slider_values: function(zero_delay, t_start, t_stop){
                var self = this;
                // console.log("set slider values", self.elWaistSig.slider);
