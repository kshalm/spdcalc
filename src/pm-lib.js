...
var sq = helpers.sq;
var pmLibMomentum = require('./pm-lib-momentum');
var properties = require('./pm-properties');
var svdcmp = require('./math/svdcmp');
...
module.exports.calc_delK = function calc_delK (P){
...
module.exports.calc_PM_tz = function calc_PM_tz (P){
    ...
    var delK = module.exports.calc_delK(P);
    ...
    var calczterms = function(z){
        var Q_sR = Ws_SQ,
            ...
            Q_pR = Wp_SQ,
            Q_pI = 2*z/kp,
            Q_sR_SQ = helpers.cmultiplyR(Q_sR, Q_sI, Q_sR, Q_sI),
            Q_sI_SQ = helpers.cmultiplyI(Q_sR, Q_sI, Q_sR, Q_sI),
            Q_iR_SQ = helpers.cmultiplyR(Q_iR, Q_iI, Q_iR, Q_iI),
            Q_iI_SQ = helpers.cmultiplyI(Q_iR, Q_iI, Q_iR, Q_iI),
            Q_pR_SQ = helpers.cmultiplyR(Q_pR, Q_pI, Q_pR, Q_pI),
            Q_pI_SQ = helpers.cmultiplyI(Q_pR, Q_pI, Q_pR, Q_pI);

        var Q_isR = helpers.cmultiplyR(Q_iR,Q_iI,Q_sR, Q_sI);
        var Q_isI = helpers.cmultiplyI(Q_iR,Q_iI,Q_sR, Q_sI);

        var Q_ispR = helpers.cmultiplyR(Q_pR,Q_pI,Q_isR, Q_isI);
        var Q_ispI = helpers.cmultiplyI(Q_pR,Q_pI,Q_isR, Q_isI);

        var Q_ipR = helpers.cmultiplyR(Q_iR,Q_iI,Q_pR, Q_pI);
        var Q_ipI = helpers.cmultiplyI(Q_iR,Q_iI,Q_pR, Q_pI);

        var Q_spR = helpers.cmultiplyR(Q_sR,Q_sI,Q_pR, Q_pI);
        var Q_spI = helpers.cmultiplyI(Q_sR,Q_sI,Q_pR, Q_pI);
        ...
        var Anum2c2R = helpers.caddR(Anum2aR, Anum2aI, Anum2c1R, Anum2c1I);
        var Anum2c2I = helpers.caddI(Anum2aR, Anum2aI, Anum2c1R, Anum2c1I);
        var Anum2R = helpers.cmultiplyR(Anum2c2R, Anum2c2I, Q_iR, Q_iI);
        var Anum2I = helpers.cmultiplyI(Anum2c2R, Anum2c2I, Q_iR, Q_iI);
        // var Anum = Wi_SQ*Ws_SQ*Wp_SQ*(Anum1 + Anum2);
        var Anum12R = helpers.caddR(Anum1R, Anum1I, Anum2R, Anum2I);
        var Anum12I = helpers.caddI(Anum1R, Anum1I, Anum2R, Anum2I);
        var AnumR = helpers.cmultiplyR(Q_ispR, Q_ispI, Anum12R, Anum12I);
        var AnumI = helpers.cmultiplyI(Q_ispR, Q_ispI, Anum12R, Anum12I);
        var Anum = AnumR;

        // var Aden = 16*(Wp_SQ*Ws_SQ + Wi_SQ*(Wp_SQ+Ws_SQ))*( sq(COS_THETAi)*Wp_SQ*Ws_SQ + Wi_SQ*(sq(COS_THETAs)*Wp_SQ+Ws_SQ));
        var Aden1R = helpers.caddR(Q_spR,Q_spI,Q_ipR, Q_ipI);
        var Aden1I = helpers.caddI(Q_spR,Q_spI,Q_ipR, Q_ipI);
        var Aden2R = helpers.caddR(Aden1R,Aden1I,Q_isR, Q_isI);
        var Aden2I = helpers.caddI(Aden1R,Aden1I,Q_isR, Q_isI);
        var Aden3R = sq(COS_THETAi)*Q_spR;
        var Aden3I = sq(COS_THETAi)*Q_spI;
        var Aden4R = sq(COS_THETAs)*Q_ipR;
        var Aden4I = sq(COS_THETAs)*Q_ipI;
        var Aden5R = helpers.caddR(Aden3R, Aden3I, Aden4R, Aden4I);
        var Aden5I = helpers.caddI(Aden3R, Aden3I, Aden4R, Aden4I);
        var Aden6R = helpers.caddR(Aden5R, Aden5I, Q_isR, Q_isI);
        var Aden6I = helpers.caddI(Aden5R, Aden5I, Q_isR, Q_isI);
        var AdenR = 16 * helpers.cmultiplyR(Aden6R, Aden6I, Aden2R,Aden2I);
        var AdenI = 16 * helpers.cmultiplyI(Aden6R, Aden6I, Aden2R,Aden2I);

        var AR = helpers.cdivideR(AnumR, AnumI, AdenR, AdenI);
        var AI = helpers.cdivideI(AnumR, AnumI, AdenR, AdenI);


        var Bnum1aR = Q_pR_SQ * Bnum1;
        var Bnum1aI = Q_pI_SQ * Bnum1;
        var Bnum1R = helpers.cmultiplyR(Bnum1aR, Bnum1aI, Q_sR_SQ, Q_sI_SQ);
        var Bnum1I = helpers.cmultiplyI(Bnum1aR, Bnum1aI, Q_sR_SQ, Q_sI_SQ);
        ...
        // var Bnum2 = Wi_SQ*Wp_SQ*Ws_SQ*(Bnum2a + Bnum2b);
        var Bnum2cR = helpers.caddR(Bnum2aR, Bnum2aI, Bnum2bR, Bnum2bI );
        var Bnum2cI = helpers.caddI(Bnum2aR, Bnum2aI, Bnum2bR, Bnum2bI );
        var Bnum2R = helpers.cmultiplyR(Bnum2cR, Bnum2cI, Q_ispR, Q_ispI);
        var Bnum2I = helpers.cmultiplyI(Bnum2cR, Bnum2cI, Q_ispR, Q_ispI);
        // var Bnum3a = -4*sq(Wp_SQ)*(SIN_2THETAs*SIN_PHIs*delK[0]+COS_PHIs*SIN_2THETAs*delK[1]-2*sq(COS_THETAs)*delK[2]) + 8*sq(Ws_SQ)*(delK[2]+delK[1]*RHOpx);
        var Bnum3a1R = Bnum3a1 * Q_pR_SQ;
        var Bnum3a1I = Bnum3a1 * Q_pI_SQ;
        var Bnum3a2R = Bnum3a2 * Q_sR_SQ;
        var Bnum3a2I = Bnum3a2 * Q_sI_SQ;
        var Bnum3aR = helpers.caddR(Bnum3a1R,Bnum3a1I,Bnum3a2R,Bnum3a2I);
        var Bnum3aI = helpers.caddI(Bnum3a1R,Bnum3a1I,Bnum3a2R,Bnum3a2I);
        // var Bnum3b = Wp_SQ* Ws_SQ*(4*(3 + COS_2THETAs)*delK[2] +delK[0]*(-4*SIN_2THETAs*SIN_PHIs + (6+2*COS_2THETAs+COS_2THETAs_minus_PHIs-2*COS_2PHIs+COS_2THETAs_plus_PHIs)*RHOpx) +8*COS_PHIs*SIN_THETAs*delK[1]*(-COS_THETAs+SIN_THETAs*SIN_PHIs*RHOpx));
        var Bnum3bR = Bnum3b * Q_spR;
        var Bnum3bI = Bnum3b * Q_spI;
        // var Bnum3 = sq(Wi_SQ)*(Bnum3a + Bnum3b);
        var Bnum3cR = helpers.caddR(Bnum3aR, Bnum3aI, Bnum3bR, Bnum3bI);
        var Bnum3cI = helpers.caddI(Bnum3aR, Bnum3aI, Bnum3bR, Bnum3bI);
        var Bnum3R = helpers.cmultiplyR(Bnum3cR, Bnum3cI, Q_iR_SQ, Q_iI_SQ);
        var Bnum3I = helpers.cmultiplyI(Bnum3cR, Bnum3cI, Q_iR_SQ, Q_iI_SQ);
        // var Bnum = Bnum1 + Bnum2 +Bnum3;
        var BnumaR = helpers.caddR(Bnum1R, Bnum1I, Bnum2R, Bnum2I);
        var BnumaI = helpers.caddI(Bnum1R, Bnum1I, Bnum2R, Bnum2I);
        var BnumR = helpers.caddR(BnumaR, BnumaI, Bnum3R, Bnum3I);
        var BnumI = helpers.caddI(BnumaR, BnumaI, Bnum3R, Bnum3I);
        // var B = 2*Bnum / (Aden);
        var BR = 2* helpers.cdivideR(BnumR, BnumI, AdenR, AdenI);
        var BI = 2* helpers.cdivideI(BnumR, BnumI, AdenR, AdenI);
        ...
        var CnumaR = Q_pR * Cnuma,
            ...
            CnumcR = Q_iR * Cnumc,
            CnumcI = Q_iI * Cnumc,
            CnumdR = helpers.caddR(CnumaR, CnumaI, CnumbR, CnumbI),
            CnumdI = helpers.caddI(CnumaR, CnumaI, CnumbR, CnumbI),
            CnumR = helpers.caddR(CnumdR, CnumdI, CnumcR, CnumcI),
            CnumI = helpers.caddI(CnumdR, CnumdI, CnumcR, CnumcI);
        ...
        var CdenaR = sq(COS_THETAi)*Q_spR,
            ...
            CdencR = helpers.caddR(CdenaR, CdenaI, CdenbR, CdenbI),
            CdencI = helpers.caddI(CdenaR, CdenaI, CdenbR, CdenbI),
            CdenR = 2*helpers.caddR(CdencR, CdencI, Q_isR, Q_isI),
            CdenI = 2*helpers.caddI(CdencR, CdencI, Q_isR, Q_isI);

        var CR = helpers.cdivideR(CnumR, CnumI, CdenR, CdenI),
            CI = helpers.cdivideI(CnumR, CnumI, CdenR, CdenI);

        // var coeff1R = helpers.caddR(Q_isR, Q_isI, Q_ipR, Q_ipI);
        // var coeff1I = helpers.caddI(Q_isR, Q_isI, Q_ipR, Q_ipI);

        // var coeffinvR = helpers.caddR(coeff1R, coeff1I, Q_spR, Q_spI);
        // var coeffinvI = helpers.caddI(coeff1R, coeff1I, Q_spR, Q_spI);
        // // Math.sqrt(Wp_SQ*Ws_SQ*Wi_SQ)
        // var coeffR = helpers.cdivideR(Math.sqrt(Wp_SQ*Ws_SQ*Wi_SQ), 0, coeffinvR, coeffinvI);
        // var coeffI = helpers.cdivideI(Math.sqrt(Wp_SQ*Ws_SQ*Wi_SQ), 0, coeffinvR, coeffinvI);

        // gaussnorm = (1/Math.sqrt(pi2 * Ws_SQ)) * (1/Math.sqrt(pi2 * Wi_SQ)) * (1/Math.sqrt(pi2 * Wp_SQ));
        var gN = sq(1/Math.sqrt(Math.PI*2))*1/Math.sqrt(Math.PI*2),
            gaussR = helpers.cdivideR(gN * Math.sqrt(Ws_SQ * Wi_SQ *Wp_SQ), 0 , Q_ispR,Q_ispI),
            gaussI = helpers.cdivideI(gN * Math.sqrt(Ws_SQ * Wi_SQ *Wp_SQ), 0 , Q_ispR,Q_ispI);

        // xconst1 = (sq(COS_PHIs) + sq(COS_THETAi)*sq(SIN_PHIs))/Wi_SQ;
        var xconst1R = helpers.cdivideR((sq(COS_PHIs) + sq(COS_THETAi)*sq(SIN_PHIs)), 0, Q_iR, Q_iI),
            xconst1I = helpers.cdivideI((sq(COS_PHIs) + sq(COS_THETAi)*sq(SIN_PHIs)), 0, Q_iR, Q_iI),
            // xconst1 += 1/Wp_SQ;
            xconst2R = helpers.cdivideR(1, 0, Q_pR, Q_pI),
            xconst2I = helpers.cdivideI(1, 0, Q_pR, Q_pI),
            xconst3R = helpers.caddR(xconst1R,xconst1I,xconst2R,xconst2I),
            xconst3I = helpers.caddI(xconst1R,xconst1I,xconst2R,xconst2I),
            // xconst1 += (sq(COS_PHIs) + sq(COS_THETAs)*sq(SIN_PHIs))/Ws_SQ;
            xconst4R = helpers.cdivideR(sq(COS_PHIs) + sq(COS_THETAs)*sq(SIN_PHIs), 0, Q_sR, Q_sI),
            xconst4I = helpers.cdivideI(sq(COS_PHIs) + sq(COS_THETAs)*sq(SIN_PHIs), 0, Q_sR, Q_sI),
            xconst5R = helpers.caddR(xconst3R,xconst3I,xconst4R,xconst4I),
            xconst5I = helpers.caddI(xconst3R,xconst3I,xconst4R,xconst4I),
            // Math.sqrt(xconst1);
            xconst6R = helpers.csqrtR(xconst5R, xconst5I),
            xconst6I = helpers.csqrtI(xconst5R, xconst5I),
            // xconst = Math.sqrt(2*Math.PI)/Math.sqrt(xconst1);
            xconstR = helpers.cdivideR(Math.sqrt(2*Math.PI),0,xconst6R, xconst6I),
            xconstI = helpers.cdivideI(Math.sqrt(2*Math.PI),0,xconst6R, xconst6I);
        ...
        //
        var ynum1R = helpers.caddR(Q_spR,Q_spI,Q_ipR,Q_ipI),
            ynum1I = helpers.caddI(Q_spR,Q_spI,Q_ipR,Q_ipI),
            ynum2R = helpers.caddR(ynum1R,ynum1I,Q_isR,Q_isI),
            ynum2I = helpers.caddI(ynum1R,ynum1I,Q_isR,Q_isI),
            // (sq(COS_THETAi))*Wp_SQ*Ws_SQ + Wi_SQ*(sq(COS_THETAs)*Wp_SQ+Ws_SQ )
            ynum3R = helpers.caddR(sq(COS_THETAs)*Q_ipR, sq(COS_THETAs)*Q_ipI, Q_isR, Q_isI),
            ynum3I = helpers.caddI(sq(COS_THETAs)*Q_ipR, sq(COS_THETAs)*Q_ipI, Q_isR, Q_isI),
            ynum4R = helpers.caddR(ynum3R, ynum3I, sq(COS_THETAi)*Q_spR, sq(COS_THETAi)*Q_spI),
            ynum4I = helpers.caddI(ynum3R, ynum3I, sq(COS_THETAi)*Q_spR, sq(COS_THETAi)*Q_spI),
            // (Wp_SQ*Ws_SQ + Wi_SQ*(Wp_SQ+Ws_SQ))*(sq(COS_THETAi)*Wp_SQ*Ws_SQ + Wi_SQ*(sq(COS_THETAs)*Wp_SQ+Ws_SQ ));
            ynumR = helpers.cmultiplyR(ynum2R,ynum2I,ynum4R,ynum4I),
            ynumI = helpers.cmultiplyI(ynum2R,ynum2I,ynum4R,ynum4I);


        // // yconst denominator
        // // yconst2 = Wi_SQ*Wp_SQ*Ws_SQ*((sq(COS_PHIs)+sq(COS_THETAi)*sq(SIN_PHIs))*Wp_SQ*Ws_SQ + Wi_SQ* (( sq(COS_PHIs) + sq(COS_THETAs) * sq(SIN_PHIs)) *Wp_SQ +Ws_SQ));
        var c1 = (sq(COS_PHIs) + sq(COS_THETAs) * sq(SIN_PHIs)),
            yden1R = helpers.caddR(c1*Q_ipR, c1*Q_ipI, Q_isR, Q_isI),
            yden1I = helpers.caddI(c1*Q_ipR, c1*Q_ipI, Q_isR, Q_isI),
            c2 = (sq(COS_PHIs)+sq(COS_THETAi)*sq(SIN_PHIs)),
            yden2R = helpers.caddR(c2*Q_spR, c2*Q_spI, yden1R, yden1I),
            yden2I = helpers.caddI(c2*Q_spR, c2*Q_spI, yden1R, yden1I),
            ydenR = helpers.cmultiplyR(Q_ispR,Q_ispI, yden2R, yden2I),
            ydenI = helpers.cmultiplyI(Q_ispR,Q_ispI, yden2R, yden2I);

        // yconst = Math.sqrt(2*Math.PI)/Math.sqrt(yconst1/yconst2);
        var yconstd1R = helpers.cdivideR(ynumR, ynumI, ydenR, ydenI),
            yconstd1I = helpers.cdivideI(ynumR, ynumI, ydenR, ydenI),
            yconstd2R = helpers.csqrtR(yconstd1R, yconstd1I),
            yconstd2I = helpers.csqrtI(yconstd1R, yconstd1I),
            yconstR = helpers.cdivideR(Math.sqrt(2*Math.PI), 0, yconstd2R, yconstd2I),
            yconstI = helpers.cdivideI(Math.sqrt(2*Math.PI), 0, yconstd2R, yconstd2I);


        var coeffaR = helpers.cmultiplyR(gaussR, gaussI, xconstR, xconstI),
            coeffaI = helpers.cmultiplyI(gaussR, gaussI, xconstR, xconstI),
            coeffR = helpers.cmultiplyR(coeffaR, coeffaI, yconstR, yconstI),
            coeffI = helpers.cmultiplyI(coeffaR, coeffaI, yconstR, yconstI);
    ...
    var zintfunc = function(z){
        ...
        var real = helpers.cmultiplyR(realE, imagE, coeffR,coeffI);
        var imag = helpers.cmultiplyI(realE, imagE, coeffR,coeffI);
    ...
    if (P.calcfibercoupling){
        ...
        var pmintz = helpers.Nintegrate2arg(zintfunc,-P.L/2, P.L/2,dz,P.numzint,P.zweights);
    ...
    // var PMz_real = helpers.Nintegrate(zintReal,-P.L/2, P.L/2,numz)/P.L;
    // var PMz_imag = helpers.Nintegrate(zintImag,-P.L/2, P.L/2,numz)/P.L;
 ...
 */
module.exports.pump_spectrum = function pump_spectrum (P){
 ...
 * P is SPDC Properties object
 */
module.exports.phasematch = function phasematch (P){

    // var pm = module.exports.calc_PM_tz(P);
    // var pm = pmLibMomentum.calc_PM_tz_k_singles(P);
    // var todeg = 180/Math.PI;
    // console.log("Inside phasematch:  Theta_s: " + (P.theta_s*todeg).toString() + ", Theta_i: " + (P.theta_i*todeg).toString() );
    var pm = pmLibMomentum.calc_PM_tz_k_coinc(P);
    ...
    // }
    // Pump spectrum
    var alpha = module.exports.pump_spectrum(P);
    // var alpha = 1;
 ...
 * P is SPDC Properties object
 */
module.exports.phasematch_coinc = function phasematch_coinc (P){
 ...
 * P is SPDC Properties object
 */
module.exports.phasematch_singles = function phasematch_singles(P){
 ...
 * P is SPDC Properties object
 */
module.exports.phasematch_Int_Phase = function phasematch_Int_Phase(P){

    // PM is a complex array. First element is real part, second element is imaginary.
    var PM = module.exports.phasematch(P);
 ...
 * P is SPDC Properties object
 */
module.exports.phasematch_Int_Phase_Singles = function phasematch_Int_Phase_Singles(P){

    // PM is a complex array. First element is real part, second element is imaginary.
    var PM = module.exports.phasematch_singles(P);
 ...
 */
module.exports.normalize_joint_spectrum = function normalize_joint_spectrum (props){
    ...
    var norm = module.exports.phasematch_Int_Phase(P)['phasematch'];
    return norm;
 ...
 */
module.exports.normalize_joint_spectrum_singles = function normalize_joint_spectrum_singles (props){
    // Find the optimum phase matching condition. This will be when delK = 0 and everything is collinear.
    // Need to calculate optimum poling period and crystal angle.
    var P = props.clone();
    P.theta_s = 0;
    ...
    var norm = module.exports.phasematch_Int_Phase_Singles(P)['phasematch'];//*(Wi_SQ*PHI_s);
    return norm;
 ...
 */
module.exports.calc_HOM_rate = function calc_HOM_rate(ls_start, ls_stop, li_start, li_stop, delT, JSA, dim){
 ...
 * delT is the time delay between signal and idler
 */
module.exports.calc_HOM_bunch_rate = function calc_HOM_rate(ls_start, ls_stop, li_start, li_stop, delT, JSA, dim){
 ...
 * delT is the time delay between signal and idler
 */
module.exports.calc_HOM_scan = function calc_HOM_scan(P, t_start, t_stop, ls_start, ls_stop, li_start, li_stop, dim, dip){
    // console.log(dip);
    // dip = dip || true;
    // console.log(dip);
    ...
    var delT = helpers.linspace(t_start, t_stop, dim);

    var HOM_values = helpers.linspace(t_start, t_stop, dim);
    var PM_JSA1 = PlotHelpers.calc_JSA(P, ls_start, ls_stop, li_start, li_stop, npts);
    var PM_JSA2 = PlotHelpers.calc_JSA(P, li_start, li_stop, ls_start, ls_stop, npts);

    var PM_JSA1_real = helpers.create_2d_array(PM_JSA1[0], npts,npts);
    var PM_JSA1_imag = helpers.create_2d_array(PM_JSA1[1], npts,npts);
    var PM_JSA2_real = helpers.create_2d_array(helpers.AntiTranspose(PM_JSA2[0],npts), npts,npts);
    var PM_JSA2_imag = helpers.create_2d_array(helpers.AntiTranspose(PM_JSA2[1],npts), npts,npts);
    ...
    var PM_JSI = PlotHelpers.calc_JSI(P, ls_start, ls_stop, li_start, li_stop, npts);

    // Calculate normalization
    var N = helpers.Sum(PM_JSI),
        rate;

    for (var i=0; i<dim; i++){
        if (dip){
            rate = module.exports.calc_HOM_rate(ls_start, ls_stop, li_start, li_stop, delT[i], JSA, npts);
        }
        else {
            rate = module.exports.calc_HOM_bunch_rate(ls_start, ls_stop, li_start, li_stop, delT[i], JSA, npts);
        }
 ...
 * delT is the time delay between signal and idler
 */
module.exports.calc_HOM_scan_p = function calc_HOM_scan(P, delT, ls_start, ls_stop, li_start, li_stop, npts, dip){
    // console.log(dip);
    // dip = dip || true;
    // console.log(dip);
 ...
 * delT is the time delay between signal and idler
 */
module.exports.calc_HOM_JSA = function calc_HOM_JSA(P, ls_start, ls_stop, li_start, li_stop, delT, dim, dip){
    var PM_JSA1 = PlotHelpers.calc_JSA(P, ls_start, ls_stop, li_start, li_stop, dim);
    var PM_JSA2 = PlotHelpers.calc_JSA(P, li_start, li_stop, ls_start, ls_stop, dim);

    var PM_JSA1_real = helpers.create_2d_array(PM_JSA1[0], dim,dim);
    var PM_JSA1_imag = helpers.create_2d_array(PM_JSA1[1], dim,dim);
    var PM_JSA2_real = helpers.create_2d_array(helpers.AntiTranspose(PM_JSA2[0],dim), dim,dim);
    var PM_JSA2_imag = helpers.create_2d_array(helpers.AntiTranspose(PM_JSA2[1],dim), dim,dim);
    ...
    if (dip){
        JSI = module.exports.calc_HOM_rate(ls_start, ls_stop, li_start, li_stop, delT, JSA, dim);
    }
    else {
        JSI = module.exports.calc_HOM_bunch_rate(ls_start, ls_stop, li_start, li_stop, delT, JSA, dim);
    }
 ...
 */
module.exports.calc_2HOM_rate = function calc_HOM_rate(delT, ls_start, ls_stop, li_start, li_stop, PM_JSA_real, PM_JSA_imag, dim){

    var lambda_s = helpers.linspace(ls_start,ls_stop, dim);
    var lambda_i = helpers.linspace(li_start,li_stop, dim);
    var rate_ss = 0;
    var rate_ii = 0;
    var rate_si = 0;

    // var PM_JSA_real = helpers.create_2d_array(PM_JSA[0], dim, dim);
    // var PM_JSA_imag = helpers.create_2d_array(PM_JSA[1], dim, dim);
 ...
 * P is SPDC Properties object
 */
module.exports.calc_2HOM_norm = function calc_HOM_norm(PM_JSA_real, PM_JSA_imag, dim){
    var rate = 0;
 ...
 * delT is the time delay between signal and idler
 */
module.exports.calc_2HOM_scan = function calc_HOM_scan(P, t_start, t_stop, ls_start, ls_stop, li_start, li_stop, dim){

    var npts = 30;  //number of points to pass to PlotHelpers.calc_JSA()
    // dim = 20;
    var delT = helpers.linspace(t_start, t_stop, dim);
    ...
    var PM_JSA = PlotHelpers.calc_JSA(P, ls_start, ls_stop, li_start, li_stop, npts); // Returns the complex JSA

    var PM_JSA_real = helpers.create_2d_array(PM_JSA[0], npts, npts);
    var PM_JSA_imag = helpers.create_2d_array(PM_JSA[1], npts, npts);

    // Calculate normalization
    var N = module.exports.calc_2HOM_norm(PM_JSA_real, PM_JSA_imag, npts);
    // var N = 1;

    for (var i=0; i<dim; i++){
        // PM_JSA = module.exports.calc_HOM_JSA(P, ls_start, ls_stop, li_start, li_stop, delT[i], npts);
        // var total = helpers.Sum(PM_JSA)/N;
        var rates = module.exports.calc_2HOM_rate(delT[i], ls_start, ls_stop, li_start, li_stop, PM_JSA_real, PM_JSA_imag, npts);
 ...
 * delT is the time delay between signal and idler
 */
module.exports.calc_2HOM_scan_p = function calc_HOM_scan(P, delT, ls_start, ls_stop, li_start, li_stop, dim){
 ...
 */
module.exports.calc_Schmidt = function calc_Schmidt(PM){
    // var PM2D = helpers.create2Darray(PM, dim,dim);
    ...
    // var Norm = helpers.Sum(D); // Normalization
 ...
 */
module.exports.autorange_lambda = function autorange_lambda(props, threshold){
    var P = props.clone();
    ...
    var PMmax = module.exports.phasematch_Int_Phase(P);
    ...
    var lambda_limit = function(lambda_s){
        ...
        var PM = module.exports.phasematch_Int_Phase(P);
    ...
    var ans = nelderMead(lambda_limit, guess, 50);
...
module.exports.autorange_delT = function autorange_delT(props, lambda_start, lambda_stop){
    // var P = props.clone();
...
module.exports.autorange_delT_2crystal = function autorange_delT_2crystal(props, lambda_start, lambda_stop){
    // var P = props.clone();
...
module.exports.autorange_theta = function autorange_theta(props){
    var P = props.clone();
    P.update_all_angles();
    ...
    P.update_all_angles();
    theta_start = module.exports.find_external_angle(P,"signal");

    P.theta_s = theta_end;
    P.update_all_angles();
    theta_end = module.exports.find_external_angle(P,"signal");
...
module.exports.autorange_poling_period = function autorange_poling_period(props){
    var P = props.clone();
...
module.exports.find_internal_angle = function find_internal_angle (props, photon){
    var P = props.clone(),
        snell_external,
        guess,
        min_snells_law;
    ...
    var ans = nelderMead(min_snells_law, guess, 40);
    // console.log("Internal angle is: ", ans*180/Math.PI, props.theta_s*180/Math.PI );
    return ans;
};

module.exports.find_external_angle = function find_external_angle (props, photon){
...
module.exports.swap_signal_idler = function swap_signal_idler(P){
    ...
    P.W_sx = P.W_ix;
    P.W_sy = P.W_iy;
    P.theta_s_e = module.exports.find_external_angle(P, "signal");
